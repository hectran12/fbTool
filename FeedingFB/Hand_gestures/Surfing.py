...
class Action:
    ...
    def surfing_fbwatch (self, surfing_second_min=10, surfing_second_max=20, watch_time_min=30, watch_time_max=60, after_watch_to_click='') -> bool:
        self.driver.get('https://www.facebook.com/watch')
        randomSecond = random.randint(surfing_second_min, surfing_second_max)
        randomWatch = random.randint(watch_time_min, watch_time_max)
        ##############js scroll
        js_scroll = '''
    ...
    def surfing_group_feed (self, surfing_second_min=10, surfing_second_max=20, after_suring_to_click_uri='https://www.facebook.com/profile.php?id=100077557920226') -> bool:
        ...
        # discover
        self.driver.find_element('xpath', f'//*[@id="{fbIDElement}"]/div/div[1]/div/div[3]/div/div/div/div[1]/div[1]/div[1]/div/div[3]/div[1]/div[2]/div/div[2]/a/div[1]/div[2]/div/div/div/div/span/span').click()
    ...
    def surfing_news_feed (self, surfing_second_min=10, surfing_second_max=20, after_suring_to_click_uri='https://www.facebook.com/profile.php?id=100077557920226') -> bool:
